...
class RepositoryClubImpl extends RepositoryClub {
  ...
  Future<Club> getClub(int clubId) {
    return ApiClient.getRequest(
      ...
      dataConstructor: (data) => Club.fromJson(Map<String, dynamic>.from(data)),
    );
  }
    ...
    return ApiClient.getRequest(
      ...
      dataConstructor: (data) {
        if (data is List) {
          return data
              .map(
                (e) => SummaryActivity.fromJson(Map<String, dynamic>.from(e)),
              )
              .toList();
        }
        return [];
  ...
  Future<List<SummaryAthlete>> listClubAdministrators(
    ...
    return ApiClient.getRequest(
      ...
      dataConstructor: (data) {
        if (data is List) {
          return data
              .map((e) => SummaryAthlete.fromJson(Map<String, dynamic>.from(e)))
              .toList();
        }
        return [];
      },
