...
import 'package:strava_client/src/domain/repository/repository_segment_effort.dart';
...
class RepositorySegmentEffortImpl extends RepositorySegmentEffort {
  ...
  Future<DetailedSegmentEffort> getSegmentEffort(int segmentId) {
    return ApiClient.getRequest(
        endPoint: "/v3/segment_efforts/$segmentId",
        dataConstructor: (data) =>
            DetailedSegmentEffort.fromJson(Map<String, dynamic>.from(data)));
  }
  ...
  Future<List<DetailedSegmentEffort>> listSegmentEfforts(
    ...
    return ApiClient.getRequest(
        endPoint: "/v3/segment_efforts",
        queryParameters: queryParams,
        dataConstructor: (data) {
          if (data is List) {
            return data
                .map((e) => DetailedSegmentEffort.fromJson(
