...
final List<ApiCall> kApiCalls = [
  ...
  ApiCall(
    ...
    run: (c, a) => c.activities.createActivity(
  ...
  ApiCall(
    ...
    run: (c, a) => c.segments.getLeaderBoard(
  ...
  ApiCall(
    ...
    run: (c, a) => c.streams.getActivityStreams(
      a["activityId"] as int,
      a["keys"] as List<String>,
    ),
  ),
  ApiCall(
    group: "Stream",
  ...
  ApiCall(
    ...
    run: (c, a) => c.streams.getSegmentStreams(
      a["segmentId"] as int,
      a["keys"] as List<String>,
    ),
  ),
